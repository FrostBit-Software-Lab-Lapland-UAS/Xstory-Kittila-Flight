...
![alt text](https://github.com/FrostBit-Software-Lab-Lapland-UAS/Xstory-Kittila-Flight/blob/main/xstory_logot_white.png?raw=true "Partner and financier logos")
...
- Repositorio sisältää historialliseen Kittilän sijoittuvan lentosimulaattorin
...
- Projektissa on käytössä Unreal Engine 5.4
</br>
...
- The repository contains a flight simulator located in historical Kittilä
